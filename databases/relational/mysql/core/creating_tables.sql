# Creating a table - We create based off a data model (ERD) we can create on paper or an app like eraser.io CREATE TABLE IF NOT EXISTS tanners_sample_table (
...
# Update column name and optionally its data type
...
# modify a column to change its properties but not its name.
